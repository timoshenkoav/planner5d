...
class ProjectsRepository(
    ...
    suspend fun list(): List<Project> {
        return withContext(scope.coroutineContext) {
            listOf(
                ...
                Project("luxurious and minimalist house ( white & gold )", "2b9b43c47d5c2901e1816dbf03857932"),
                Project("Dream bathroom: Design battle contest", "956790cecc5f9e99156e8b41d2b54337"),
    ...
    suspend fun info(hash: String): ProjectInfoResponse {
        return withContext(scope.coroutineContext) {
            plannerApi.getProjectInfo(hash)
        }
    }
}